...
def fetch_billboard_hot_100():
    try:
        ...
        print(f"Failed to fetch Billboard: {e}. Using fallback data.")
        return [
            {"title": "Beautiful Things", "artist": "Benson Boone", "rank": 1},
            {"title": "La Diabla", "artist": "Xavi", "rank": 2},
            {"title": "Lose Control", "artist": "Teddy Swims", "rank": 3},
            {"title": "Seven", "artist": "Jung Kook", "rank": 4},
            {"title": "Water", "artist": "Tyla", "rank": 5}
        ]
